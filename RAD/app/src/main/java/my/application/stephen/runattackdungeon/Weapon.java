...
public class Weapon extends Clutter {
    ...
    Weapon(int atkPower, int newValue, Point3d mPoint, Bitmap newImage, int HPMax) {
        super(newValue, mPoint, newImage, HPMax);
        attackPower = atkPower;
        setCellType(CellType.Weapon);
    }
    Weapon(int atkPower, int enchant, int newValue, Point3d mPoint, Bitmap newImage, int HPMax) {
